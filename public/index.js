...
var AppContainer = React.createClass({
  ...
  render: function render() {
    ...
    if (this.state.page == 'home') {
      currentPage = React.createElement(HomePage, null);
    } else if (this.state.page == 'about') {
      currentPage = React.createElement(AboutPage, null);
    }
    ...
    return React.createElement(
      ...
      React.createElement(Navbar, {
        ...
        homeClick: function homeClick() {
          return _this.setState({ page: 'home' });
        },
        aboutClick: function aboutClick() {
          return _this.setState({ page: 'about' });
        }
      }),
      this.state.page == 'home' ? React.createElement(Carousel, null) : '',
      currentPage,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'li',
              { className: this.props.page == 'home' ? 'active nav-item' : '' },
              React.createElement(
                'a',
                { onClick: this.props.homeClick, className: 'nav-link', href: '#' },
                'Home'
              )
            ),
            React.createElement(
              'li',
              { className: this.props.page == 'about' ? 'active nav-item' : '' },
              React.createElement(
                'a',
                { onClick: this.props.aboutClick, className: 'nav-link', href: '#' },
                'About'
              )
            )
          )
